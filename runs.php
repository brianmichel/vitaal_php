...
$myRuns=mysql_fetch_array($result1);
...
?>
		...
		<!--Main Content-->
		<div id="content">
			<div id="leftColumn"><STRONG>My Runs</STRONG>
					...
					<div id="columnText">
						<table>
							<tr>
								...
								<td>:</td>
								<td align='left'><?echo $myRuns['time']?></td>
							</tr>
							<tr>
								<td align='left'>Personal Best</td>
								<td>:</td>
								<td align='left'><?echo $myRuns['bestTime']?></td>
							</tr>
							<tr>
								<td align='left'>Ran</td>
								<td>:</td>
								<td align='left'><?php echo $myRuns['timeAgo']; echo " "; echo $myRuns['periodAgo'];?> ago</td>
							</tr>				
						</table> 
					</div>							
				</div>
			...
			<div id="midColumn"><STRONG>Friend's Runs</STRONG>
				<?php
			...
			<div id="rightColumn"><STRONG>Neighborhood Runs</STRONG>
				<?php
